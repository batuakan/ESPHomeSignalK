...
namespace signalk
{
    ...
    void SignalkSubscriber::set_path(std::string path)
    {
        this->path_ = std::move(path);
    }

    void SignalkSubscriber::set_period(int period)
    {
        this->period_ = period;
    }

    void SignalkSubscriber::set_format(std::string format)
    {
        this->format_ = std::move(format);
    }

    void SignalkSubscriber::set_policy(std::string policy)
    {
        this->policy_ = std::move(policy);
    }

    void SignalkSubscriber::set_min_period(int min_period)
    {
        this->min_period_ = min_period;
    }

    // -------- Accessors --------

    std::string SignalkSubscriber::get_path()
    {
        return this->path_;
    }

    int SignalkSubscriber::get_period()
    {
        return this->period_;
    }

    std::string SignalkSubscriber::get_format()
    {
        return this->format_;
    }

    std::string SignalkSubscriber::get_policy()
    {
        return this->policy_;
    }

    int SignalkSubscriber::get_min_period()
    {
        return this->min_period_;
    }

    // -------- Parent pointer --------

    void SignalkSubscriber::set_parent(SignalK *parent)
    {
        this->parent_ = parent;
    }
